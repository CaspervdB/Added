...
cap = cv2.imread('Image00000.JPG')               # '0' is the webcam's ID. usually it is 0 or 1. 'cap' is the video object.
...
while True:
    ...
    cv2.imshow("Hole detector", im_with_keypoints)            # display the frame with keypoints added.
